    ...
    <div class="flex flex-wrap items-center justify-between py-6">
        ...
        <div class="sm:hidden md:block lg:block">
            <ul class="flex justify-end ">
                <li class="">
                    <a href="https://www.facebook.com/Informatika.Unsyiah/?locale=id_ID" target="_blank" title="">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Ebene 1" width="48" height="30"
                            viewBox="0 0 1024 1024" id="facebook-logo-2019">
                            <path fill="#1877f2"
                ...
                <li class="ml-6">
                    <a href="https://twitter.com/informatika_Usk" target="_blank" title="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="48" height="30"
                            id="twitter">
                            <path fill="#03A9F4"
                ...
                <li class="ml-6 none">
                    <a href="https://www.instagram.com/hmif_usk/" target="_blank" title="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="30" viewBox="0 0 102 102"
                            id="instagram">
                            <defs>
